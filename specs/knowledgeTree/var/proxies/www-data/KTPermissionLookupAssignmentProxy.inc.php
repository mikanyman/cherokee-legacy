<?php
class KTPermissionLookupAssignmentProxy extends KTPermissionLookupAssignment {
    ...
    function getbypermissionanddescriptor() { $aArgs = func_get_args(); return $this->_callOnObject("getbypermissionanddescriptor", $aArgs); }

    function getbypermissionandlookup() { $aArgs = func_get_args(); return $this->_callOnObject("getbypermissionandlookup", $aArgs); }

    function _getlookupidsbypermissionidanddescriptorid() { $aArgs = func_get_args(); return $this->_callOnObject("_getlookupidsbypermissionidanddescriptorid", $aArgs); }

    function findorcreatelookupbypermissiondescriptormap() { $aArgs = func_get_args(); return $this->_callOnObject("findorcreatelookupbypermissiondescriptormap", $aArgs); }

    function &_fetch() {
        if (!empty($GLOBALS["_OBJECTCACHE"]["KTPermissionLookupAssignment"][$this->iId])) {
            $oObject =& $GLOBALS["_OBJECTCACHE"]["KTPermissionLookupAssignment"][$this->iId];
            return $oObject;
        }
        $oObject =& new KTPermissionLookupAssignment;
        $res = $oObject->load($this->iId);
        if (PEAR::isError($res)) {
            return $res;
        }
        $GLOBALS["_OBJECTCACHE"]["KTPermissionLookupAssignment"][$this->iId] =& $oObject;
        return $oObject;
    }
    ...
    function KTPermissionLookupAssignmentProxy ($iId) { $this->iId = $iId; }
